package com.jobapplication.reviewms.review;

import java.util.List;

import com.jobapplication.reviewms.review.messaging.ReviewMessageProducer;
...
public class ReviewController {
  ...
  public ResponseEntity<String> addReview(
      @RequestParam Long companyId, @RequestBody Review review) {
